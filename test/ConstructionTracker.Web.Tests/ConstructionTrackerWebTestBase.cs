...
public abstract class ConstructionTrackerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static ConstructionTrackerWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(ConstructionTrackerWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<ConstructionTrackerDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<ConstructionTrackerDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<ConstructionTrackerDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<ConstructionTrackerDbContext, Task<T>> func)
    {
        T result;
