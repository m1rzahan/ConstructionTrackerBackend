...
namespace ConstructionTracker.EntityFrameworkCore.Seed.Host;
...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = ConstructionTrackerConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(ConstructionTrackerDbContext context)
    {
        _context = context;
    }
